...
select concat (first_name," gets Rs ",salary*12) as "Emp info" from emp;
...
select employee_id,first_name,salary as "Monthly salary" ,salary*12 as "Annual salary" from emp order by salary * 12;
